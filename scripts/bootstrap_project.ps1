...
Write-Host "2. Fill in develop\\IMPLEMENTATION_PLAN.md and develop\\LOCAL_RUNBOOK.md"
Write-Host "3. Fill in develop\\TODO.md and develop\\CHECKPOINT.md"
Write-Host "4. Add the first checkpoint spec under develop\\stages\\"
Write-Host "5. Update AGENTS.md for the project"
Write-Host "6. Review .claude\\rules\\project-checklist.md and .cursor\\rules\\project-canon.mdc"
