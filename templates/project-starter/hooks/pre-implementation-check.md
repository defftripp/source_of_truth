...
7. Required capability sources are declared before install/update is proposed.
8. External writes, secrets, payments and deploys are outside scope unless approved.
